...
- Cadastrar novo ecoponto via formulário (nome, descrição, endereço completo, foto). O endereço é convertido em coordenadas automaticamente via API do OpenStreetMap (Nominatim) — sem necessidade de chave de API para o geocoding.
...
---
### `app/_layout.js`
Configuração global de navegação. Registra as três rotas: lista, novo ecoponto e detalhes.
